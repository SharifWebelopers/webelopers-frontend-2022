    ...
    <div className={styles.container}>
      ...
      <TabPanel value={tab} index={0}>
        <div className={styles["tab-panel-item"]}>
          <ProfilePicture src={state.profile_image} />
